        ...
        <div class="d-flex align-items-center py-3 py-md-1">
            ...
            <div class="me-4">
                ...
                <a href="#" class="btn btn-custom btn-active-white btn-flex btn-color-white btn-active-color-primary fw-bolder" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                    {!! theme()->getIcon("filter", "fs-5 text-gray500 me-1") !!}
                    Filter
                </a>
            ...
            @if (!empty($primaryButtonUrl))
                <a href="{{ $primaryButtonUrl }}" class="btn bg-body btn-active-color-primary" id="kt_toolbar_primary_button">
                    {{ $primaryButtonLabel }}
                </a>
            @else
                <a href="#" class="btn {{ theme()->isDarkMode() ? 'btn-success' : 'btn bg-body btn-active-color-primary' }}" data-bs-toggle="modal" data-bs-target="{{ $primaryButtonModalTarget }}" id="kt_toolbar_primary_button">
                    {{ $primaryButtonLabel }}
                </a>
            @endif
            <!--end::Button-->
