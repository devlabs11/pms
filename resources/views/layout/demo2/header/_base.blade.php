    ...
    <div class="{{ theme()->printHtmlClasses('header-container', false) }} d-flex align-items-center">
        ...
        <div class="d-flex topbar align-items-center d-lg-none ms-n2 me-3" title="Show aside menu">
            <div class="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px" id="kt_header_menu_mobile_toggle">
                {!! theme()->getIcon("abstract-14", "fs-2x") !!}
            </div>
        </div>
        ...
        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <a href="{{ theme()->getPageUrl('') }}">
                <img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/demo2.png') }}" class="logo-default h-25px"/>
                <img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/demo2-sticky.png') }}" class="logo-sticky h-25px"/>
            </a>
        </div>
        <!--end::Header Logo-->
