...
<div
	...
	<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
		...
		<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
			<a href=" {{ theme()->getPageUrl('') }}">
				<img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/demo7.svg') }}" class="h-30px"/>
			</a>
		</div>
		<!--end::Logo-->
		...
		<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
			...
			<div class="d-flex align-items-center mb-2">
				...
				<div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
					...
					title="Quick links"
				>
					{!! theme()->getIcon("element-plus", "fs-2 fs-lg-1") !!}
				</div>
			...
			<div class="d-flex align-items-center mb-2">
				...
				<div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
					...
					data-bs-dismiss="click"
					title="Notifications">
					{!! theme()->getIcon("element-11", "fs-2 fs-lg-1") !!}
				</div>
			...
			<div class="d-flex align-items-center mb-3">
				...
				id="kt_activities_toggle">
					{!! theme()->getIcon("chart-simple", "fs-2 fs-lg-1") !!}
				</div>
				<!--end::drawer toggle-->
			</div>
			<!--end::Activities-->
	...
	@if(theme()->getOption('layout', 'aside/secondary-display') === true)
		...
		<!--begin::Aside Toggle-->
		<button class="aside-toggle btn btn-sm btn-icon bg-body btn-color-gray-700 btn-active-primary position-absolute translate-middle start-100 end-0 bottom-0 shadow-sm d-none d-lg-flex mb-5 {{ theme()->printHtmlClasses('asideToggle', false) }}"
			data-kt-toggle="true"
			...
			{!! theme()->getIcon("arrow-left", "fs-2 rotate-180") !!}
		</button>
		<!--end::Aside Toggle-->
	@endif
</div>
